...
export function MedicalDisclaimer() {
  return (
    <div className="bg-red-50 dark:bg-red-900/20 border-l-4 border-red-500 p-4 my-6 rounded-r-md">
      <div className="flex">
        ...
        <div className="ml-3">
          <h3 className="text-sm font-medium text-red-800 dark:text-red-300">Medical Disclaimer</h3>
