    ...
    <div className="max-w-3xl mx-auto space-y-8">
      ...
      <article className="prose prose-gray dark:prose-invert max-w-none">
        <p className="text-[var(--muted)] mb-6 text-lg font-medium">
          The short version: LunaCycle does not collect, store, or transmit your cycle data to any external server. No accounts required, no cloud sync, just complete data sovereignty.
        </p>
