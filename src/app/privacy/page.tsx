    ...
    <div className="max-w-3xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-[var(--muted)]">
          Go back to the <Link href="/" className="text-[var(--primary)] hover:underline">homepage</Link> or learn more <Link href="/about" className="text-[var(--primary)] hover:underline">about us</Link>.
        </p>
      </div>

      <article className="prose prose-gray dark:prose-invert max-w-none">
        <p className="text-[var(--muted)] mb-6 text-lg font-medium">
          The short version: LunaCycle does not collect, store, or transmit your cycle data to any external server. We use local storage, meaning we have no accounts and no cloud sync. Your data is entirely yours.
        </p>

        <h2 className="heading-3 mt-8 mb-4">1. Local Storage Only</h2>
        <p className="text-[var(--muted)] mb-6">
          All data you input into LunaCycle (such as period start dates) is stored exclusively on your device using your web browser&apos;s standard <code>localStorage</code> API. We do not operate a backend database for user data, meaning we physically cannot access your health information. There are no user accounts, and no data is synced to the cloud.
        </p>
