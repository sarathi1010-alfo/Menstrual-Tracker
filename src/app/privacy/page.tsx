    ...
    <div className="max-w-3xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-[var(--muted)] text-lg">
          Last updated: {new Date().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}. Return to the <Link href="/" className="text-[var(--primary)] hover:underline">LunaCycle Tracker</Link> or learn more <Link href="/about" className="text-[var(--primary)] hover:underline">About Us</Link>.
        </p>
      </div>
