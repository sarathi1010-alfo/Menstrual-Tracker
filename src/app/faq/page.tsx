    ...
    <div className="max-w-3xl mx-auto space-y-8">
      ...
      <div>
        ...
        <p className="text-[var(--muted)] text-lg">
          Everything you need to know about tracking your cycle with LunaCycle. Learn more about us on our <Link href="/about" className="text-[var(--primary)] hover:underline">About page</Link> or return to the <Link href="/" className="text-[var(--primary)] hover:underline">Homepage</Link>.
        </p>
      </div>
