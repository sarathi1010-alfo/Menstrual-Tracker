    ...
    <div className="max-w-3xl mx-auto space-y-8">
      ...
      <div className="space-y-6">
        ...
        <div className="card p-6 border-l-4 border-[var(--accent)]">
          <h3 className="heading-3 mb-2 text-[var(--accent)]">Can I use this for birth control?</h3>
          <p className="text-[var(--muted)] font-medium">
            No. LunaCycle is designed for educational and tracking purposes only.
          </p>
          <p className="text-[var(--muted)] mt-2 italic text-sm">
            Medical Disclaimer: The fertile window estimations are based on standard calendar calculations, which are not reliable enough to prevent pregnancy. Please consult with a healthcare professional for reliable contraception methods.
          </p>
        </div>
