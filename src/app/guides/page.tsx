...
export const metadata: Metadata = {
  title: 'Cycle Health Guides & Education',
  description: 'Evidence-based, privacy-first guides to understanding your menstrual cycle, tracking, and reproductive health.',
};
