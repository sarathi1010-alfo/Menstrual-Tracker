...
import { ArrowLeft, BookOpen, Share2, AlertCircle, CheckCircle2, HelpCircle } from 'lucide-react';
    ...
    <div className="flex flex-col lg:flex-row gap-12 max-w-6xl mx-auto">
      <article className="lg:w-2/3">
        ...
        <div className="mb-8">
          ...
          {/* Medical Disclaimer */}
          <div className="flex items-start gap-3 p-4 rounded-lg bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800/50 mb-8">
            ...
            <p className="text-sm text-amber-800 dark:text-amber-400 m-0">
              <strong>Medical Disclaimer:</strong> This content is for educational purposes only and does not constitute medical advice. Always consult with a healthcare professional for medical concerns or before making health decisions.
            </p>
          </div>
        </div>
        ...
        {article.meta.takeaways && article.meta.takeaways.length > 0 && (
          <div className="card p-6 mb-10 border-l-4 border-l-[var(--primary)]">
