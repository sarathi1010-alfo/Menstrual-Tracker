...
export async function generateStaticParams() {
  ...
  // Only generate for cluster/pillar articles here
  return allArticles
    .filter(a => !a.category || a.category === 'cluster' || a.category === 'pillar')
    .map(a => ({ slug: a.slug }));
}
      ...
      <article className="lg:w-2/3">
        ...
        <div className="mb-8">
          ...
          {article.meta.takeaways && article.meta.takeaways.length > 0 && (
            <div className="p-5 rounded-xl bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 shadow-sm mb-10">
