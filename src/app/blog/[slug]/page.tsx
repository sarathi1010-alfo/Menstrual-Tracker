...
export default async function ArticlePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const faqsSchema = article.meta.faqs && article.meta.faqs.length > 0 ? {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-12 max-w-6xl mx-auto">
      <article className="lg:w-2/3">
        ...
        {faqsSchema && <SchemaMarkup schema={faqsSchema} />}
        <div className="mb-8">
          ...
          <div className="mt-10">
            ...
            <div className="space-y-4">
              {article.meta.faqs.map((faq, index) => (
                <div key={index} className="border border-gray-200 dark:border-gray-800 rounded-lg p-5">
