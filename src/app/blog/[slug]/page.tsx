...
export async function generateStaticParams() {
  ...
  return articles
    .filter(a => a.category === 'cluster' || !a.category)
...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  if (!article || (article.meta.category !== 'cluster' && article.meta.category)) {
    ...
    <div className="flex flex-col lg:flex-row gap-12 max-w-6xl mx-auto">
      <article className="lg:w-2/3">
        ...
        <div className="mb-8">
          ...
          {article.meta.takeaways && article.meta.takeaways.length > 0 && (
            <div className="mb-8 bg-[var(--surface)] p-6 rounded-xl border border-gray-200 dark:border-gray-800">
      ...
      <aside className="lg:w-1/3 space-y-8">
        <div className="card p-6 bg-[var(--primary)] text-white shadow-lg sticky top-24">
          <h3 className="text-xl font-bold mb-3">Track Your Cycle</h3>
          <p className="text-white/80 text-sm mb-6">
            LunaCycle is 100% private. Save everything locally on your device.
          </p>
