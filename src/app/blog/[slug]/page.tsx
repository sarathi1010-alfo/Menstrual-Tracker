              ...
              <ul className="space-y-3">
                {article.meta.takeaways.map((takeaway, idx) => (
                  <li key={idx} className="flex items-start">
                    <span className="w-1.5 h-1.5 rounded-full bg-[var(--primary)] mt-2 mr-3 flex-shrink-0"></span>
                    <span className="text-[var(--muted)]">{takeaway}</span>
                  </li>
                ))}
              </ul>
            </div>
          ...
          <div className="mt-12 pt-10 border-t border-gray-200 dark:border-gray-800">
            ...
            <div className="space-y-6">
              {article.meta.faqs.map((faq, index) => (
                <div key={index} className="bg-[var(--surface)] rounded-lg p-5 border border-gray-100 dark:border-gray-800">
