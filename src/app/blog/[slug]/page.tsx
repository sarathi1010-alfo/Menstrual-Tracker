...
export default async function ArticlePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const articleSchema = {
    ...
    "publisher": {
      ...
      "logo": {
        "@type": "ImageObject",
        "url": "https://lunacycle.example.com/logo.png"
      }
    }
  };
      ...
      <article className="lg:w-2/3">
        ...
        <div className="mb-8">
          ...
          {article.meta.takeaways && article.meta.takeaways.length > 0 && (
            <div className="p-6 rounded-xl bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800/30 shadow-sm mt-6 mb-8">
              <h2 className="text-xl font-bold text-blue-900 dark:text-blue-100 mb-4">Key Takeaways</h2>
