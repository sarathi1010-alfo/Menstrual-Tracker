...
export async function generateStaticParams() {
  ...
  // explicit dynamic routes handle categories like 'what-is'
  const blogArticles = articles.filter(a => a.category !== 'what-is' && a.category !== 'use-cases' && a.category !== 'conditions');
