      ...
      <article className="lg:w-2/3">
        ...
        <div className="mb-8">
          ...
          {article.meta.takeaways && article.meta.takeaways.length > 0 && (
            <div className="p-6 rounded-xl bg-[var(--primary)]/5 border border-[var(--primary)]/20 shadow-sm mt-8 mb-10">
              ...
              <ul className="space-y-3 m-0">
                {article.meta.takeaways.map((takeaway, idx) => (
                  <li key={idx} className="flex items-start">
                    <CheckCircle2 size={20} className="text-[var(--primary)] mr-3 flex-shrink-0 mt-0.5" />
          ...
          <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-800">
            ...
            <div className="space-y-6">
              {article.meta.faqs.map((faq, idx) => (
                <div key={idx} className="bg-[var(--surface)] p-6 rounded-xl border border-gray-100 dark:border-gray-800">
