    ...
    <div className="flex flex-col lg:flex-row gap-12 max-w-6xl mx-auto">
      <article className="lg:w-2/3">
        ...
        {article.meta.takeaways && article.meta.takeaways.length > 0 && (
          <div className="mb-10 p-6 bg-[var(--primary)]/5 border border-[var(--primary)]/20 rounded-xl shadow-sm">
          ...
          <div className="mt-12">
            ...
            <div className="space-y-4">
              {article.meta.faqs.map((faq, index) => (
                <details key={index} className="group border border-gray-200 dark:border-gray-800 rounded-lg open:bg-gray-50 dark:open:bg-gray-800/50">
                  <summary className="flex cursor-pointer items-center justify-between p-4 font-medium text-[var(--foreground)] marker:content-none">
                    {faq.question}
                    <svg className="w-5 h-5 transition duration-300 group-open:-rotate-180" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
