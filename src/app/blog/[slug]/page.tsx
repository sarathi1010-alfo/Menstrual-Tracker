...
export async function generateStaticParams() {
  ...
  return articles
    .filter(article => article.category === 'blog' || !article.category || article.category === '')
    .map((article) => ({
      slug: article.slug,
    }));
}
...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  if (!article || article.meta.category !== 'blog' && article.meta.category && article.meta.category !== '') {
    return {
