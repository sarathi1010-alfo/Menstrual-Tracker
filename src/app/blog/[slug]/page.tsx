...
export async function generateStaticParams() {
  ...
  return articles
    .filter(a => !a.category || a.category === 'cluster' || a.category === 'comparison')
    .map((a) => ({
      slug: a.slug,
    }));
}
        ...
        <div className="mb-8">
          ...
          {article.meta.takeaways && article.meta.takeaways.length > 0 && (
            <div className="p-5 rounded-xl bg-[var(--primary)]/5 border border-[var(--primary)]/20 shadow-sm mb-10">
              <h2 className="text-lg font-bold text-[var(--primary)] mb-3">Key Takeaways</h2>
          ...
          <div className="card p-6">
            ...
            <div className="space-y-4">
              {relatedArticles.map(related => {
                ...
                else if (related.category === 'use-cases') href = `/use-cases/${related.slug}`;
                else if (related.category === 'conditions') href = `/conditions/${related.slug}`;
