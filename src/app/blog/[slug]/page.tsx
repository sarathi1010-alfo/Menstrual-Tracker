    ...
    <div className="flex flex-col lg:flex-row gap-12 max-w-6xl mx-auto">
      <article className="lg:w-2/3">
        ...
        {article.meta.takeaways && article.meta.takeaways.length > 0 && (
          <div className="my-8 p-6 bg-[var(--primary)]/5 border border-[var(--primary)]/20 rounded-xl shadow-sm">
            <h3 className="text-xl font-bold text-[var(--primary)] mb-4">Key Takeaways</h3>
          ...
          <div className="my-10">
            ...
            <div className="space-y-4">
              {article.meta.faqs.map((faq, idx) => (
                <details key={idx} className="group border border-gray-200 dark:border-gray-800 rounded-lg bg-white dark:bg-gray-900 overflow-hidden">
                  <summary className="font-semibold px-5 py-4 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors flex justify-between items-center text-[var(--foreground)]">
                    {faq.question}
                    <span className="text-[var(--muted)] group-open:rotate-180 transition-transform duration-200">
                      ▼
                    </span>
                  </summary>
                  <div className="px-5 py-4 bg-gray-50 dark:bg-gray-800/20 text-[var(--foreground)] leading-relaxed border-t border-gray-200 dark:border-gray-800">
                    {faq.answer}
                  </div>
                </details>
              ))}
