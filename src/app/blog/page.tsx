...
export const metadata: Metadata = constructMetadata({
  title: 'LunaCycle Blog - Menstrual Health & Privacy Education',
  description: 'Evidence-based guides to understanding your menstrual cycle, tracking methods, and reproductive health. Privacy-first educational resources from LunaCycle.',
  path: '/blog',
});
