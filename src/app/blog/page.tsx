...
export const metadata: Metadata = {
  title: 'Blog - LunaCycle Period Tracking Resources',
  description: 'Free evidence-based guides to understanding your menstrual cycle, tracking methods, and reproductive health.',
};

export default function BlogIndexPage() {
  // Only show cluster/pillar articles on the main blog page, not micro-answers, use-cases, conditions
  const articles = getAllArticles().filter(a => !a.category || a.category === 'cluster' || a.category === 'pillar');
