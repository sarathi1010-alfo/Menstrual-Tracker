...
export const metadata: Metadata = constructMetadata({
  title: 'LunaCycle Blog - Menstrual Health Education & Cycle Insights',
  description: 'Explore evidence-based articles about menstrual cycle phases, hormones, privacy-first tracking, and reproductive health. Education by LunaCycle.',
  path: '/blog',
});
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-12">
      <header className="text-center space-y-4">
        ...
        <h1 className="heading-1">LunaCycle Education</h1>
        <p className="text-xl text-[var(--muted)] max-w-2xl mx-auto">
          Understand your body with our library of cycle mechanics, tracking methodology, and health indicators.
        </p>
      </header>
