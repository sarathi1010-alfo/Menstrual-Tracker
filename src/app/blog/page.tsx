...
export const metadata: Metadata = {
  title: 'Cycle Health Articles & Education - LunaCycle Blog',
  description: 'Free evidence-based articles and resources for understanding your menstrual cycle, tracking methods, and reproductive health. Privacy-first education from LunaCycle.',
};
