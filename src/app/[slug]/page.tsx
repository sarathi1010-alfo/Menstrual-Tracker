...
export async function generateStaticParams() {
  ...
  // Only explicitly route 'what-is' micro-answers to the top level
  return allArticles
...
export default async function TopLevelExplicitRoutePage({ params }: { params: Promise<{ slug: string }> }) {
  const resolvedParams = await params;
  const article = getArticleBySlug(resolvedParams.slug);
  ...
  const articleSchema = {
    ...
    "@type": "FAQPage", // Micro-answers default to FAQPage schema representing the direct question
    "mainEntity": [{
      "@type": "Question",
