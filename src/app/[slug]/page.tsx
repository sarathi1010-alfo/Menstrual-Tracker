...
export default async function MicroAnswerPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <h1 className="text-3xl md:text-4xl font-bold tracking-tight mb-4 text-[var(--foreground)]">
        {article.meta.title}
      </h1>

      <div className="text-lg font-medium text-[var(--foreground)] bg-[var(--surface)] border-l-4 border-[var(--primary)] pl-4 py-2 mb-8">
        {article.meta.summary}
      </div>

      {article.meta.takeaways && article.meta.takeaways.length > 0 && (
        <div className="bg-[var(--secondary)]/10 rounded-xl p-5 mb-8">
