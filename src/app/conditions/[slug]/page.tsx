...
export async function generateStaticParams() {
  ...
  // Filter for conditions category
  const conditionArticles = articles.filter(article => article?.meta.category === 'conditions');

  return conditionArticles.map((article) => ({
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <SchemaMarkup
        schema={{
          ...
          url: `https://lunacycle.alfo.online/conditions/${slug}`,
        }}
      />
