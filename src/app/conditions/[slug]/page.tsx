  ...
  return (
    <article className="max-w-3xl mx-auto space-y-8">
      ...
      <header className="space-y-4 mb-8 text-center">
        <div className="inline-block px-3 py-1 bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-300 rounded-full text-sm font-medium mb-2">
      ...
      {meta.takeaways && meta.takeaways.length > 0 && (
        <div className="card p-6 mb-8 border-l-4 border-l-red-500">
