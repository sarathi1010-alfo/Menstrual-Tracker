...
export default async function BlogPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const relatedArticles = allArticles
    .filter(a => a.slug !== article.meta.slug && a.tags.some(t => article.meta.tags.includes(t)) && a.category === 'conditions')
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-12 max-w-6xl mx-auto">
      <article className="lg:w-2/3">
        ...
        <div className="mb-8">
          <Link href="/conditions" className="inline-flex items-center text-sm text-[var(--muted)] hover:text-[var(--primary)] mb-6 transition-colors">
