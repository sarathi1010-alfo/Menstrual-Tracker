...
export default async function ConditionPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const relatedArticles = allArticles
    .filter(a => a.category === 'conditions' && a.slug !== article.meta.slug && a.tags.some(t => article.meta.tags.includes(t)))
    .slice(0, 3);
      ...
      <article className="lg:w-2/3">
        ...
        <div className="mb-8">
          ...
          {article.meta.takeaways && article.meta.takeaways.length > 0 && (
            <div className="p-5 rounded-xl bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800/50 mb-10">
              <h2 className="text-sm font-bold text-blue-700 dark:text-blue-400 uppercase tracking-wider mb-3">
                Key Takeaways
              </h2>
          ...
          <div className="card p-6">
            ...
            <div className="space-y-4">
              {relatedArticles.map(related => (
                <Link key={related.slug} href={`/conditions/${related.slug}`} className="block group">
