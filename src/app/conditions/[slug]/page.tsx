      ...
      <article className="lg:w-2/3">
        ...
        <div className="mb-8">
          ...
          {article.meta.takeaways && article.meta.takeaways.length > 0 && (
            <div className="p-6 rounded-xl bg-orange-50 dark:bg-orange-900/20 border border-orange-100 dark:border-orange-800 mb-10">
              <h2 className="text-xl font-bold mb-4 text-orange-900 dark:text-orange-100">Key Takeaways</h2>
              <ul className="list-disc pl-5 space-y-2 text-orange-800 dark:text-orange-200">
            ...
            <div className="space-y-4">
              {relatedArticles.map(related => (
                <Link
                  key={related.slug}
                  href={
                    related.category === 'use-cases' ? `/use-cases/${related.slug}` :
                    related.category === 'conditions' ? `/conditions/${related.slug}` :
                    related.category === 'what-is' ? `/${related.slug}` :
                    `/blog/${related.slug}`
                  }
