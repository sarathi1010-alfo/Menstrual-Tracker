      ...
      <div className="mb-8">
        ...
        <div className="flex gap-2 mb-4 flex-wrap">
          {article.meta.tags.map(tag => (
            <span key={tag} className="text-xs font-medium px-2.5 py-1 bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300 rounded-full">
              {tag}
            </span>
          ))}
        </div>
        ...
        <div className="p-5 rounded-xl bg-red-50 dark:bg-red-900/10 border border-red-200 dark:border-red-900/20 shadow-sm mt-8 mb-6">
          <h2 className="text-sm font-bold text-red-600 dark:text-red-400 uppercase tracking-wider mb-2 flex items-center">
             <Activity size={16} className="mr-2" /> Condition Overview
          </h2>
