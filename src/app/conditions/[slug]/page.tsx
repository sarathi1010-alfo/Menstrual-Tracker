...
export default async function ConditionPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const relatedArticles = allArticles
    .filter(g => g.category === 'conditions' && g.slug !== article.meta.slug && g.tags.some(t => article.meta.tags.includes(t)))
  ...
  const articleSchema = {
    ...
    "publisher": {
      ...
      "logo": {
        "@type": "ImageObject",
        "url": "https://lunacycle.alfo.online/favicon.ico"
      }
    }
  };
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-12 max-w-6xl mx-auto px-4 md:px-8 py-8">
      <article className="lg:w-2/3">
        ...
        <div className="mb-8">
          ...
          {article.meta.takeaways && article.meta.takeaways.length > 0 && (
            <div className="p-6 rounded-xl bg-[var(--primary)]/5 border border-[var(--primary)]/20 mb-8">
